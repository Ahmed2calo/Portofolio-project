...
const Contact: React.FC = () => (
  <section className="section min-h-screen bg-black text-white flex justify-center items-center text-center py-16">
    <div className="max-w-4xl w-full px-6 py-10 bg-gray-800 rounded-xl shadow-2xl">
      ...
      <div className="space-y-4 mb-8">
        <p className="text-xl">My Name: <span className="font-bold text-blue-400">Ahmed</span></p>
        <p className="text-xl">Phone: <span className="font-bold text-blue-400">0557539539</span></p>
        <p className="text-xl">Email: <span className="font-bold text-blue-400">202111434@aau.ac.ae</span></p>
      </div>
